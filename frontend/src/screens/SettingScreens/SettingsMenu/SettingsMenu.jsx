...
return (
  <>
    ...
    <div className="header flex bg-gray-800 text-white justify-between items-center py-2 px-5">
      <div className="left flex items-center px-1 py-2">
        <i className="fas fa-arrow-left fs-6 fw-bold mx-1 text-xl rounded-full py-1 px-1 hover:bg-gray-500 transition-all" onClick={(e) => history.push('/Home')}></i>
